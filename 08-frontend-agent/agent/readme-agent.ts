...
export class ReadmeAgent {
  ...
  private analyzeProject(): {
    ...
    const hasFrontend = existsSync('outputs/frontend.ts');
...
${projectInfo.hasFrontend ? '│   ├── frontend.ts             # Enhanced frontend code' : '│   ├── frontend.ts             # (no frontend generated yet)'}
...
${projectInfo.hasFrontend ? '✅ **Frontend**: Enhanced frontend code with email field generated' : '❌ **Frontend**: No frontend code generated yet'}
